...
type PortalHandlerClient interface {
	...
	CreateLoginLink(ctx context.Context, in *CreateLoginLinkRequest, opts ...grpc.CallOption) (*CreateLoginLinkReply, error)
}
...
func (c *portalHandlerClient) CreateLoginLink(ctx context.Context, in *CreateLoginLinkRequest, opts ...grpc.CallOption) (*CreateLoginLinkReply, error) {
	out := new(CreateLoginLinkReply)
	err := c.cc.Invoke(ctx, "/payments_v1.PortalHandler/CreateLoginLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PortalHandlerServer interface {
	...
	CreateLoginLink(context.Context, *CreateLoginLinkRequest) (*CreateLoginLinkReply, error)
...
func (UnimplementedPortalHandlerServer) CreateLoginLink(context.Context, *CreateLoginLinkRequest) (*CreateLoginLinkReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateLoginLink not implemented")
}
...
func _PortalHandler_CreateLoginLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateLoginLinkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PortalHandlerServer).CreateLoginLink(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payments_v1.PortalHandler/CreateLoginLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PortalHandlerServer).CreateLoginLink(ctx, req.(*CreateLoginLinkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PortalHandler_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateLoginLink",
			Handler:    _PortalHandler_CreateLoginLink_Handler,
		},
	},
