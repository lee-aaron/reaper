        ...
        App::new()
            ...
            .service(
                web::scope("/v1")
                    ...
                    .route("/get_product", web::get().to(get_product))
                    .route("/update_product", web::put().to(update_product))
                    .route("/delete_product", web::delete().to(delete_product))
                    .route("/create_price", web::post().to(create_price))
                    .route("/get_price", web::get().to(get_price))
            )
