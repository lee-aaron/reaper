...
export default function Terms() {
  return (
    <React.Fragment>
      ...
      <p>Welcome to https://shuudann.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Shuudann's Website, located at https://shuudann.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use https://shuudann.com if you do not
      ...
      <p>
        We employ the use of cookies. By accessing https://shuudann.com, you
        agreed to use cookies in agreement with the Shuudann's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Shuudann and/or its licensors own the
        intellectual property rights for all material on https://shuudann.com.
        All intellectual property rights are reserved. You may access this from
        https://shuudann.com for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from https://shuudann.com</li>
        <li>Sell, rent or sub-license material from https://shuudann.com</li>
        <li>Reproduce, duplicate or copy material from https://shuudann.com</li>
        <li>Redistribute content from https://shuudann.com</li>
      </ul>
      ...
      <p>
        ...
        Shuudann does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Shuudann,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Shuudann shall not be liable
      ...
      <p>
        Shuudann reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Shuudann a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Shuudann; and (d) the link is
      ...
      <p>
        ...
        e-mail to Shuudann. Please include your name, your organization name,
      ...
      <p>
        No use of Shuudann's logo or other artwork will be allowed for linking
