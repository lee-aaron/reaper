...
export default function Privacy() {
  return (
    <React.Fragment>
      <h1>Privacy Policy for Shuudann</h1>

      <p>
        At https://shuudann.com, accessible from https://shuudann.com, one of
        ...
        https://shuudann.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in https://shuudann.com. This policy is not
      ...
      <p>
        https://shuudann.com follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, https://shuudann.com uses &apos;cookies&apos;. These
      ...
      <p>
        ...
        advertisements and links that appear on https://shuudann.com, which are
      ...
      <p>
        Note that https://shuudann.com has no access to or control over these
